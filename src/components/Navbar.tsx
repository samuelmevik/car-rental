  ...
  return (
    <div className={twMerge("z-50 h-16 w-full fixed backdrop-blur-lg", className)}>
      <div className="size-full mx-auto max-w-7xl flex justify-between items-center p-2">
        ...
        <div className={`fixed z-10 top-0 left-0 h-lvh w-svw overflow-hidden bg-secondary transition-transform duration-500 ease-in-out -translate-x-full md:!-translate-x-full ${isOpen && 'translate-x-0'}`}>
